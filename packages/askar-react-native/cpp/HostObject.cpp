...
//            rt, jsi::PropNameID::forAscii(rt, std::string("version")), 1,
...
//                return (askar::version)(rt, val->getObject(rt));
//            });
//
//    obj.setProperty(rt, jsi::String::createFromUtf8(rt, std::string("version")), func);

    return obj;
}

//AskarTurboModuleHostObject::AskarTurboModuleHostObject(jsi::Runtime &rt) {}
//
